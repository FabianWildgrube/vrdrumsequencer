...
{
    [AddComponentMenu("Scripts/MRTK/SDK/PFSVRTeleportCursor")]
    public class PFSVRTeleportCursor : AnimatedCursor, IMixedRealityTeleportHandler
    {
        ...
        public override IMixedRealityPointer Pointer
        {
            ...
            set
            {
                Debug.Assert(value is PFSVRTeleportPointer,
                    "Teleport Cursor's Pointer must derive from TeleportPointer.");

                pointer = value as PFSVRTeleportPointer;
                pointer.BaseCursor = this;
                RegisterManagers();
            }
        }

        private PFSVRTeleportPointer pointer;
